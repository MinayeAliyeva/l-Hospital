    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Faydalı Məlumatlar</h2>
        ...
        >
          {articles.map((article) => (
            <Card
              key={article.id}
              className="flex-shrink-0 w-[298px] h-[370px] rounded-[8.58px] overflow-hidden shadow-lg hover:shadow-xl transition-shadow border-0 snap-start flex flex-col"
            >
              <div className="w-full h-[307px] relative">
                <Image
                  ...
                  alt={article.title}
                  fill
                  className="object-cover w-[307px] h-[307px] rounded-t-[8.58px]"
                />
              </div>
...
//               >
//                 <Card className="w-full h-[370px] rounded-[8.58px] overflow-hidden shadow-lg hover:shadow-xl transition-shadow border-0 flex flex-col">
//                   <div className="w-full h-[307px] relative">
//                     <Image
//                       src={article.img}
//                       alt={article.title}
...
//             <CarouselNext className="static translate-y-0 rounded-full bg-[rgba(0,149,218,1)] hover:bg-blue-600 text-white" />
//           </div>
//         </Carousel>
//       </div>
//     </section>
